...
tempor incididunt ut labore et dolore magna aliqua.</p>
    ...
    <!--<div class="it-about-3-btn-box p-relative">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6"><img src="{{ asset('assets/img/about/btec_vice_dean_fact_science.jpg') }}" alt=""></div>
            <div class="col-lg-6"><img src="{{ asset('assets/img/about/btec_vice_dean_fact_pedagogy.jpg') }}" alt=""></div>
        </div>
    </div>
</div>
<!-- about-area-end -->