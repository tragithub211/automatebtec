            ...
            <div class="col-xl-6 col-lg-6">
                <div class="it-about-4-thumb-wrap d-flex align-items-center justify-content-center justify-content-lg-end">
                    <div class="it-about-4-thumb-double d-flex flex-column">
                        <img class="mb-20" src="{{ asset('assets/img/about/btec-about-left-top.jpg') }}" alt="">
                        <img src="{{ asset('assets/img/about/btec-about-left-bottom.jpg') }}" alt="">
                    </div>
                    <div class="it-about-4-thumb-single">
                        <img src="{{ asset('assets/img/about/btec-about-right-md.jpg') }}" alt="">
                    </div>
                </div>
            </div>
<div class="col-xl-6 col-lg-6">
...
<h2 class="it-section-title-3 pb-30">we are always ensure best education for our <span>Student Teachers</span>
</h2>
<p>Battambang Teacher Education College (BTEC) aims to provide Pre-Service and In-Service training programs for primary and lower secondary school teachers based on 12+4 formula and to conduct educational research for continuous improvement of the education quality within the institutions.</p>
</div>
...
<p>Leading Institution of Teacher Education in the 21st Century.</p>
</div>
</div>
</div>
</div>
